        ...
        {entries.flatMap((entry, entryIndex) => {
          ...
          return Array.from({ length: count }, (_, roundIndex) => {
            ...
            return <TableRow key={`${entry.result._id || entryIndex}-${roundIndex}`}>
              {roundIndex === 0 && <TableCell rowSpan={count} align="center">{entry.rank}</TableCell>}{roundIndex === 0 && <TableCell rowSpan={count} align="center">{athlete(entry.result.participant)}</TableCell>}{roundIndex === 0 && <TableCell rowSpan={count} align="center" className="detail-unit-cell">{unit(entry.result.participant)}</TableCell>}
