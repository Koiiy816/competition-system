...
const PrintAllResultsModal = ({ open, onClose, groupedResults, competition, teamRankings = [] }) => {
  ...
  const signaturePage = <Box className="report-page chief-signature-page" key="chief-signature-page">
    <Typography sx={{ mt: '18mm', textAlign: 'center', fontSize: '17pt', fontWeight: 'bold', fontFamily: '"SimHei", "黑体", sans-serif' }}>裁判长、副裁判长、编排长签名页</Typography>
    <Box sx={{ mt: '12mm', ml: '8%', mr: '8%', display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', rowGap: '8mm', fontSize: '14pt', fontFamily: '"SimSun", "宋体", serif' }}>
